...
def train(args):
    ...
    args.config["env_config"]["tgt_reward"] = tune.grid_search([0, 0.1, 1, 10])
    args.config["env_config"]["stp_penalty"] = tune.grid_search([0, .1, 1])
    ...
    args.config["env_config"]["beta"] = tune.grid_search([0.3, 1, 10, 0.01])
    args.config["env_config"]["beta_vel"] = tune.grid_search([0.0])
    args.config["env_config"]["crash_penalty"] = tune.grid_search([0.1, 1.0])
